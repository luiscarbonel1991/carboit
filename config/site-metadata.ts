...
const keywords: string[] = [...siteKeywords]
...
export const siteMetadata = {
  ...
  description:
    "Carboit: Where technology meets ambition. Custom software solutions designed to accelerate growth and operational efficiency for your business.",
  siteUrl: siteUrl,

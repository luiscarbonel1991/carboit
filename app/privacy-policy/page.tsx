    ...
    return (
        <>
            <MaxWithWrapper>
                ...
                <p className="mb-6">At carboit.com, accessible from https://carboit.com, one of our main priorities is
                    the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by
                    carboit.com and how we use it.</p>
                ...
                <p className="mb-6">Carboit legal basis for collecting and using the personal information described in
                    this Privacy Policy
                ...
                <p className="mb-6">Carboit will retain your personal information only for as long as is necessary for
                ...
                <p className="mb-6">If you are a resident of the European Economic Area (EEA), you have certain data
                    protection rights. If
                    you
                ...
                <p className="mb-6">carboit.com follows a standard procedure of using log files. These files log
                ...
                <p className="mb-6">You may consult this list to find the Privacy Policy for each of the advertising
                    partners of
                    carboit.com.</p>

                <p className="mb-6">Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or
                    Web Beacons that
                    are
                    used in their respective advertisements and links that appear on carboit.com, which are sent
                    directly
                    to
                ...
                <p className="mb-6">Note that carboit.com has no access to or control over these cookies that are used
                    by third-party
                    advertisers.</p>

                <h2 className="text-xl font-bold mt-6 mb-4">Third Party Privacy Policies</h2>

                <p className="mb-6">carboit.com's Privacy Policy does not apply to other advertisers or websites. Thus,
                    we are advising you
                    to
                ...
                <p className="mb-6">You can choose to disable cookies through your individual browser options. To know
                    more detailed
                    information
                ...
                <p className="mb-6">Another part of our priority is adding protection for children while using the
                    internet. We encourage
                    parents and guardians to observe, participate in, and/or monitor and guide their online
                    activity.</p>

                <p className="mb-6">carboit.com does not knowingly collect any Personal Identifiable Information from
                ...
                <p className="mb-6">Our Privacy Policy applies only to our online activities and is valid for visitors
                    to our website with
                    regards to the information that they shared and/or collect in carboit.com. This policy is not
                    applicable to
                ...
                <p className="mb-6">By using our website, you hereby consent to our Privacy Policy and agree to its
                    terms.</p>
            </MaxWithWrapper>
        </>
    )

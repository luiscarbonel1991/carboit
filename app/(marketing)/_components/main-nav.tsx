...
const MainNav = ({ dictionary }: MainNavProps) => {
    ...
    <nav className="md:ml-auto justify-end  w-full flex items-center gap-x-2">
      ...
      <Link href={"/contact"}>
        <Button
          variant={"outline"}
          className={cn(
            "rounded-3xl font-bold transition-transform hover:text-foreground/80 hover:translate-y-[-1px] hover:scale-[1.01] hover:border-b-2 hover:border-primary",

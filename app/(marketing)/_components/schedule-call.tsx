      ...
      <Card className="min-h-[300px] bg-gradient-to-b from-black to-zinc-800 shadow-xl hover:shadow-2xl">
        <CardHeader>
          <div className="flex flex-col gap-8">
            <Link href={scheduleURL} target={"_blank"} aria-label="Schedule a call with Carboit">
              <Button
                variant="secondary"
              ...
              >
                <div className="flex flex-row gap-4">
                  ...
                  <span className="text-sm text-white font-light">Slot Available</span>
                </div>
              </Button>
            </Link>

            <CardTitle className="text-7xl text-white">Join Carboit</CardTitle>
          </div>
        </CardHeader>
          ...
          <Card className="bg-transparent hover:bg-zinc-800 border border-gray-700">
            <Link href={scheduleURL} target={"_blank"} aria-label="Schedule a call with Carboit">
              <div className="flex flex-row justify-between items-center px-2">
                ...
                <Button variant="ghost" aria-label="Schedule a call with Carboit" size="icon">

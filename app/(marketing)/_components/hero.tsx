...
export const Hero = ({ lang, dictionary }: HeroProps) => {
  const { announcement, h1, button_lets_talk, h1_remark_word, image_alt, video, p_description } = dictionary.hero
      ...
      >
        ...
        <div className="py-6 md:order-1 md:block">
          {/*<Image
                    ...
                    />*/}
          <Link href={"/contact"} aria-label={announcement.question}>
            <video
              autoPlay={true}
              loop={true}
              muted={true}
        ...
        <aside>
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-400">{p_description}</p>

...
const caseStudies = [
  {
    ...
    title: "DevLach Blog",
    description:
      "DevLach is a blog designed to be a showcase of the latest technologies and trends in the world of web development. It is built using the latest technologies such as Next.js, TailwindCSS.",
  ...
  },
  {
    ...
    description:
      "TaxiPremium24hours showcases a 24-hour taxi service via a user-friendly website built with WordPress CMS, featuring responsive design and SEO optimization for enhanced visibility and performance.",
  ...
  },
  {
    ...
    description:
      "D'Acosta Upholstery is a furniture restoration company that offers a range of services. The website was built using WordPress, featuring a user-friendly design and SEO optimization.",
  ...
  },
  {
    ...
    description:
      "Luz Salón  is a beauty salon that offers a range of services. The website was built using WordPress, featuring a user-friendly design and SEO optimization.",
...
export const StudyCase = ({ dictionary }: StudyCaseProps) => {
    ...
    <section className="flex flex-col items-center space-y-8 md:space-y-12">
      <div className="flex flex-col justify-center text-center">
        ...
        <div className="mt-6 text-xl text-neutral-600">
          <p>{studyCaseDict.p_description}</p>
        </div>
      </div>
              ...
              <article className="flex flex-col min-h-[300px]">
                <Card className="rounded-3xl border-0 shadow-none hover:bg-zinc-100">
                  <figure className="p-0">
                    <Image
                      src={caseStudy.image}
                      alt="Principal View of DevLach Blog"
                      height={600}
                      width={600}
                      loading="lazy"
                  ...
                  <CardHeader>
                    ...
                    <CardDescription className="text-lg text-justify">{caseStudyData.description}</CardDescription>
                  </CardHeader>
                  <CardFooter>
                    <Link href={caseStudy.url} aria-label={`Visit ${caseStudyData.title} website`} target="_blank">

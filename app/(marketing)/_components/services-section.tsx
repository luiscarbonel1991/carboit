        ...
        <section className="container grid grid-cols-1 pt-16 px-4 md:px-10 py-10">
            ...
            <div className="flex flex-wrap w-ful mb-8">
                <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                    ...
                    <h3 className="sm:text-5xl text-4xl font-bold mb-4">We help you identify, explore and respond to new
                        opportunities.</h3>
            ...
            <div className="grid lg:grid-cols-3 gap-4 place-items-center">
                <CardService
                    ...
                    headerContent={<Terminal size={48} className="text-primary-500"/>}
                />
                ...
                <CardService
                    ...
                    headerContent={<Braces size={48} className="text-primary-500"/>}
                />
                ...
                <CardService
                    ...
                    headerContent={<AreaChart size={48} className="text-primary-500"/>}
                />
            </div>
        </section>
    )

...
const services = [
  {
    ...
    description:
      "We elevate web development by creating exquisite and functional marketing pages that capture the essence of your brand. Every site is meticulously designed to deliver an immersive experience.",
  ...
  },
  {
    ...
    description:
      "Our team is at the forefront of application development innovation, utilizing frameworks like Next.js and Spring Boot to build solutions that make a difference in usability and performance.",
  ...
  },
  {
    ...
    title: "Odoo ERP",
    description:
      "We specialize in Odoo ERP, an all-in-one management software that offers a range of business applications that form a complete suite of enterprise management applications.",
    icon: <AreaChart size={48} className="text-pink-500" />,
    link: "/services/odoo",
    image: <Image src={odoo} alt={"Odoo ERP"} width={100} height={100} className="rounded-3xl shadow-md" />
  },
  {
    id: "testing",
    title: "Testing",
    description:
      "We ensure that every project is delivered with the highest quality standards. Our testing services guarantee that your product is free of bugs and performs optimally.",
    icon: <Terminal size={48} className="text-pink-500" />,
    link: undefined,
    image: <Image src={testing} alt={"Testing"} width={100} height={100} className="rounded-3xl shadow-md" />
  },
  {
    id: "customCms",
    title: "Custom Content Management",
    description:
      "We understand the importance of a robust and personalized CMS. We step away from generic solutions to provide our clients with a unique system that powers efficient content management tailored to their needs.",
    icon: <AreaChart size={48} className="text-pink-500" />,
    link: undefined,
    image: (
      <Image
        src={customManagement}
  ...
  },
  {
    ...
    description:
      "We help businesses improve their online presence through effective SEO and digital marketing strategies. From search engine optimization to social media marketing campaigns, our goal is to increase visibility and attract the right audience.",
    icon: <AreaChart size={48} className="text-pink-500" />,
    link: undefined,
    image: (
      <Image
...
export const ServicesSection = ({ lang, dictionary }: ServicesSectionProps) => {
      ...
      <div className="flex flex-wrap w-full justify-center mb-12">
        <div className="lg:w-1/2 w-full mb-6 lg:mb-0 text-center">
          <h2 className="mb-4 flex flex-col sm:text-5xl text-4xl font-semibold gap-2">
            ...
            <span className="tracking-tight inline bg-clip-text text-transparent bg-gradient-to-b from-[#FF1CF7] to-[#b249f8]">
              {` `} {servicesDic.h1_remark_word}
            </span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">{servicesDic.p_description}</p>
          <Link href={"/contact"}>
            <Button
              className={
                "rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 scale-105 font-bold bg-gradient-to-r from-blue-600 to-purple-600"
              }
              variant={"default"}
              size={"lg"}
            >
